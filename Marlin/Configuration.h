...
#define STRING_CONFIG_H_AUTHOR "Hypercube Evolution" // Who made the changes.
...
// #define MPCTEMP         // ** EXPERIMENTAL ** See
...
#define THETA_HOMING_OFFSET                                                    \
  0 // Calculated from Calibration Guide and M360 / M114. See
    // https://www.morgan3dp.com/morgan-calibration-guide/
...
#define DEFAULT_ACCELERATION                                                   \
  2000 // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION 3000 // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION                                            \
  2000 // X, Y, Z acceleration for travel (non printing) moves
...
#define BED_TRAMMING_Z_HOP                                                     \
  4.0 // (mm) Z height of nozzle between tramming points
